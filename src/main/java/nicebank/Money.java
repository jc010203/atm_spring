...
public final class Money {
	...
	/*
	 * Determine if this Money is greater than otherAmount
	 * 
	 * Precondition this Money and otherAmount are valid Money objects
	 * 
	 * This > other
	 *  if this.dollars > other.dollars or
	 *  this.dollars == other.dollars and this.cents > other.cents
	 */
	public boolean greater(Money otherAmount) {
		boolean result = false;
		
		if (this.dollars > otherAmount.dollars) {
			result = true;
		} else if ((this.dollars == otherAmount.dollars) && (this.cents > otherAmount.cents)) {
			result = true;
		}
